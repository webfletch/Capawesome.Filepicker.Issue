...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.1b402694.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
...
window.customElements.define(
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      const self2 = this;
      self2.shadowRoot.querySelector("#select-images").addEventListener("click", async function(e) {
        try {
